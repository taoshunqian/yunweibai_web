  ...
  setup: function setup(__props) {
    ...
    */
    ...
    var comConfirm = function comConfirm(item) {
      ...
      if (isSend.value) {
        var useCmdArr = (0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_7_21_0_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(useCmd.value);

        useCmdArr.splice(1, 4);
        item.shift();
        item[3] = columnsCheckbitsIndex.indexOf(item[3]);
        useCmdArr.splice.apply(useCmdArr, [1, 0].concat((0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_7_21_0_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(item)));

        var resCmdArr = (0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_7_21_0_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_0__["default"])(allCmd.value);
...
//# sourceMappingURL=src_views_phaseTwo_PTZInfo_vue-src_components_AlarmConfig_vue-src_components_Alarm_AlarmPicke-42ceee.e14c91d7.js.map