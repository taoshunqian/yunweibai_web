...
/* harmony import */ var vant__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! vant */ "./node_modules/_vant@3.6.2@vant/es/overlay/index.mjs");
/* harmony import */ var vant__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! vant */ "./node_modules/_vant@3.6.2@vant/es/loading/index.mjs");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(__props) {
    ...
    var channelColumn = (0,vue__WEBPACK_IMPORTED_MODULE_14__.ref)([]);
    ...
    var loading = (0,vue__WEBPACK_IMPORTED_MODULE_14__.ref)(true);
    ...
    var ioType = (0,vue__WEBPACK_IMPORTED_MODULE_14__.ref)([]);
    ...
    var decodeType = function decodeType(channel, index) {
      if (ioType.value.length == 0) {
        return true;
      }

      var chanl = channel.split(" ")[1];
      var num = ioType.value[chanl - 1].indexOf(index);
    ...
    var BottomSubmit = function BottomSubmit() {
      ...
      //   alarm[3] = "0"; // 画面切换通道
      // } else {
      //   alarm[3] = +channel.value.split(" ")[1] ?? "0"; // - 1; // 画面切换通道
      // }

      alarm[3] = channelColumns3Val.value[channelColumns3.value.indexOf(channel.value)];
      ...
      var cmds = "$IOINFO," + allAlarm.value.join("!").replace(/,/g, "~").replace(/!/g, ","); // alert(cmds);
    ...
    var showPickerFn = function showPickerFn(num) {
      if (num == 1) {
        ...
        // 画面切换通道
        columns.value = channelColumns3.value;
        ...
        // 功能
        columns.value = channelColumn.value;
        defaultIndex.value = channelColumn.value.indexOf(channelInfo.value);
      }
    ...
    var callJSResult = function callJSResult(str) {
      ...
      if (cmds.indexOf("IOSIGNALTYPEV3") !== -1) {
        ...
        console.log("arrayTest", JSON.stringify(allItem)); // alert(modelType.value)
        // 匹配
      ...
      if (cmds.indexOf("IOINFO") !== -1) {
        alarmVideoChannel.value = +cmds.split(",")[1];
        ...
        for (var i = 0; i < cmdArr.length; i++) {
          ...
          if (item[0].indexOf("IPC") === -1) {
            channel2.push(t("AlarmInfoTwo.channelInfo") + (i + 1));
          }
        }

        channelColumn.value = channel2;
        loading.value = false;
    ...
    return function (_ctx, _cache) {
          ...
          return [(0,vue__WEBPACK_IMPORTED_MODULE_14__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_14__.unref)(vant__WEBPACK_IMPORTED_MODULE_20__.Cell), {
            ...
            "right-icon": (0,vue__WEBPACK_IMPORTED_MODULE_14__.withCtx)(function () {
              return [(0,vue__WEBPACK_IMPORTED_MODULE_14__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_14__.unref)(vant__WEBPACK_IMPORTED_MODULE_23__.RadioGroup), {
                ...
                "default": (0,vue__WEBPACK_IMPORTED_MODULE_14__.withCtx)(function () {
                  return [(0,vue__WEBPACK_IMPORTED_MODULE_14__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_14__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_14__.unref)(vant__WEBPACK_IMPORTED_MODULE_24__.Radio), {
                    name: "1",
                    shape: "square",
                    style: {
                      "float": "left",
                    ...
                    "icon-size": "15px",
                    disabled: ioType.value.length == 0 ? true : false
                  }, {
                    "default": (0,vue__WEBPACK_IMPORTED_MODULE_14__.withCtx)(function () {
                    ...
                    _: 1
                  }, 8, ["disabled"]), [[vue__WEBPACK_IMPORTED_MODULE_14__.vShow, decodeType(channelInfo.value, 1)]]), (0,vue__WEBPACK_IMPORTED_MODULE_14__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_14__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_14__.unref)(vant__WEBPACK_IMPORTED_MODULE_24__.Radio), {
                    name: "0",
                    shape: "square",
                    "icon-size": "15px",
                    disabled: ioType.value.length == 0 ? true : false
                    ...
                    _: 1
                  }, 8, ["disabled"]), [[vue__WEBPACK_IMPORTED_MODULE_14__.vShow, decodeType(channelInfo.value, 0)]])];
                }),
                _: 1
              }, 8, ["modelValue"])];
            }),
              ...
              return [(0,vue__WEBPACK_IMPORTED_MODULE_14__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_14__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_14__.unref)(vant__WEBPACK_IMPORTED_MODULE_25__.CheckboxGroup), {
                ...
                "default": (0,vue__WEBPACK_IMPORTED_MODULE_14__.withCtx)(function () {
                  return [((0,vue__WEBPACK_IMPORTED_MODULE_14__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_14__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_14__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_14__.renderList)(alarmVideoChannel.value, function (item, index) {
                    return (0,vue__WEBPACK_IMPORTED_MODULE_14__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_14__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_14__.unref)(vant__WEBPACK_IMPORTED_MODULE_21__.Checkbox), {
                      name: index + 1,
                      shape: "square",
                      style: {
                        "float": "left",
      ...
      }), (0,vue__WEBPACK_IMPORTED_MODULE_14__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_14__.unref)(vant__WEBPACK_IMPORTED_MODULE_28__.Overlay), {
        show: loading.value
      }, {
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_14__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_14__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_14__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_14__.unref)(vant__WEBPACK_IMPORTED_MODULE_29__.Loading), {
            type: "spinner",
            color: "#1989fa"
          })])];
        }),
...
/* harmony import */ var _AlarmIoInfo_vue_vue_type_style_index_0_id_26071b76_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AlarmIoInfo.vue?vue&type=style&index=0&id=26071b76&lang=css */ "./src/views/phaseTwo/AlarmIoInfo.vue?vue&type=style&index=0&id=26071b76&lang=css");
...
/***/ "./src/views/phaseTwo/AlarmIoInfo.vue?vue&type=style&index=0&id=26071b76&lang=css":
/*!****************************************************************************************!*\
  !*** ./src/views/phaseTwo/AlarmIoInfo.vue?vue&type=style&index=0&id=26071b76&lang=css ***!
  \****************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_clonedRuleSet_12_use_0_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_17_0_0_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_vue_loader_17_0_0_vue_loader_dist_index_js_ruleSet_0_use_0_AlarmIoInfo_vue_vue_type_style_index_0_id_26071b76_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-12.use[0]!../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../../../node_modules/_vue-loader@17.0.0@vue-loader/dist/stylePostLoader.js!../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../../../node_modules/_vue-loader@17.0.0@vue-loader/dist/index.js??ruleSet[0].use[0]!./AlarmIoInfo.vue?vue&type=style&index=0&id=26071b76&lang=css */ "./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/_vue-loader@17.0.0@vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/_vue-loader@17.0.0@vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/phaseTwo/AlarmIoInfo.vue?vue&type=style&index=0&id=26071b76&lang=css");
...
//# sourceMappingURL=src_views_phaseTwo_AlarmIoInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue.553adbbb.js.map