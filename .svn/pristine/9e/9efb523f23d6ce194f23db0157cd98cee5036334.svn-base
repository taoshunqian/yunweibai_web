  ...
  <Row>
    <Col offset="1" span="22">
      ...
      >
        <Cell>
          <template #title>
            <span class="custom-title">输出: {{ item[0] }}</span>
          </template>
          <template #right-icon>
          ...
          <Cell>
            <template #title>
              <div class="radio-group-main">
                <span style="float: left;">远程 </span>
                <span style="float: left; margin-left: 10px;">
                  <Radio name="1" shape="square" />
                </span>
              </div>
              <div class="radio-group-main">
                <span style="float: left;">手动 </span>
                <span style="float: left; margin-left: 10px;">
            ...
            <template #right-icon>
              <div style="float:right;">
                ...
                <div class="radio-group-main">
                  <span>测试 </span>
                  <span><Switch v-model="item[3]" :disabled="item[4]" size="22px" /> </span>
                </div>
              </div>
            </template>
          </Cell>
