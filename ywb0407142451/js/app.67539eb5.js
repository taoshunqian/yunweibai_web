...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(__props) {
    ...
    */
    ...
    console.log(window.location.href); // alert()
    // locale.value = "zh";
    ...
    try {
      ...
      if (model) {
        ...
        if (route == undefined) {
          ...
          _router__WEBPACK_IMPORTED_MODULE_1__["default"].push("/" + route);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/objectSpread2.js */ "./node_modules/@babel/runtime/helpers/esm/objectSpread2.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ru: (0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])((0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _phaseTwoGetMessage__WEBPACK_IMPORTED_MODULE_1__["default"].ru), {}, {
    home: "Главная",
    ...
    rotaTestNsor: {
      title: ["Включить", "Тип", "Логическая инверсия", "Период обнаружения импульса", "Состояние", "Тип соглашения"],
    ...
    dsm: {
      ...
      dialog: ["Чтобы выйти из режима мастера, нажмите ОК. Если вам нужно установить другие функции, нажмите Отмена", "Подтвердить", "Отменить"],
    ...
    stickyBottom: {
      button: ["Предыдущий", "Сохранить", "Далее", "Запрос", "Сохранить", "Полный мастер"],
      toast: "Не более~"
    },
    tab: {
      leftText: "Вернуть",
      rightText: "Лог",
      dialog: ["Советы", "Чтобы завершить работу мастера, нажмите ОК. Если вам нужно настроить другие функции, нажмите Отмена", "Подтвердить", "Отменить"],
  ...
  en: (0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])((0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _phaseTwoGetMessage__WEBPACK_IMPORTED_MODULE_1__["default"].en), {}, {
    home: "HOME",
    ...
    carInfo: {
      ...
      label: ["Device ID", "platform number", "license plate number", "License plate color", "Area Code", "Manufacturer No", "VIN frame number", "License plate classification", "Engine number", "Agreement Type"],
    ...
    alarmInfo: {
      label: ["Enable", "Buzzer", "Event Name", "type", "delayed", "Escalation type", "Capture mode", "Number of consecutive shots", "Burst interval", "Agreement Type", "Logical negation", "Switch channel", "Alarm video channel", "Capture channel"],
      // ----------- 2023/02/16 二期新增
    ...
    cameraInfo: {
      title: ["Enable", "resolving power", "Horizontal Mirror", "mirror vertically", "Set resolution"],
    ...
    platformStatus: {
      title: ["platform ", "Server IP / domain name", "Server Port", "Enable", "register", "Agreement Type", "Platform Type", "Local standards", "Device status"],
    ...
    rotaTestNsor: {
      title: ["Enable", "type", "Logical negation", "Pulse detection cycle", "state", "Agreement Type"],
    ...
    serveInfo: {
      title: ["Enable", "register", "IP/domain name", "port", "Agreement Type", "Platform Type", "Local standards", "Device State"],
    ...
    adas: {
      label: ["Vehicle width", "Camera to left side of vehicle", "Camera installation width", "Camera to bumper"],
    ...
    stickyBottom: {
      button: ["Back", "Preservation", "Next", "Query", "Preservation", "Completing the wizard"],
      toast: "No more ~"
    },
    tab: {
      leftText: "Back",
      rightText: "Log",
      dialog: ["Tips", "To end the wizard, click OK. If you need to set other functions, click Cancel", "Confirm", "Cancel"]
    },
    icCard: {
  ...
  zh: (0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])((0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_0__["default"])({}, _phaseTwoGetMessage__WEBPACK_IMPORTED_MODULE_1__["default"].zh), {}, {
    home: "首页",
    ...
    stickyBottom: {
      button: ["上一步", "保存", "下一步", "查询", "保存", "完成向导"],
      toast: "没有更多了~"
    },
    tab: {
      leftText: "返回",
      rightText: "Log",
      dialog: ["提示", "结束向导, 请点击确认, 如果还需设置其他功能, 请点击取消. ", "确认", "取消"],
  ...
  tw: {
    ...
    rotaTestNsor: {
      title: ["啟用", "類型", "邏輯反", "脈衝檢測週期", "狀態", "協定類型"],
    ...
    stickyBottom: {
      button: ["上一步", "保存", "下一步", "査詢", "保存", "完成嚮導"],
      toast: "沒有更多了~"
    },
    tab: {
      leftText: "返回",
      rightText: "Log",
      dialog: ["提示", "結束嚮導,請點擊確認,如果還需設定其他功能,請點擊取消. ", "確認", "取消"],
      stateArr: ["正常", "连接成功", "断开", "重连中", "心跳超时", "wifi断开", "wifi连接"]
    },
    icCard: {
      label: ["驾驶证号码", "驾驶证有效期", "从业资格证号码", "从业资格证有效期", "驾驶员姓名", "驾驶员代码", "公司", "性别", "星级"],
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ru: {
    ...
    "AlarmOutput": {
      "content": ["Вывод", "Удаленный", "Вручную", "Связь", "Тест"],
      "navTitle": "IO выход"
    },
    "CodeStream": {
      ...
      "androidStatus_fn": ['Основной поток', 'Дополнительный поток']
    },
    "CodeStreamDetails": {
      ...
      "navTitle": "Основной/Дополнительный поток",
      "androidStatus_fn": ["Канал основного потока", "Канал дополнительного потока"]
    },
    "ComInfo": {
    ...
    "LoadSettings": {
      "navTitle": "Нагрузка",
      "template": ["Модель", "Напряжение тока", "Вес тока", "Номер калибровки", "Удалить", "Добавить", "Серийный номер", "Текущий вес", "Калиброванный вес"],
    ...
    "ReversingCamera": {
      "template": ["Включить", "Видеоканал", "Триггерный переключатель", "Видео выход", "Время ожидания", "Введите время ожидания", "Область настройки", "Подтвердить отмену"],
    ...
    "AlarmInfoTwo": {
      ...
      "toast": ["Не обнаружено, канал IO выбирает текущую функцию и автоматически сопоставляется с каналом", "канал"],
      "channelInfo": "Канал "
    },
    icCard: {
      ...
      columns: "Мужской, Женский",
      navTitle: "IC-карта",
      dateShowTitle: "Выберите год, месяц и день"
    }
  },
  en: {
    "ConfigConst": {
    ...
    "AlarmOutput": {
      "content": ["Output", "Remote", "Manual", "Linkaged", "Test"],
      "navTitle": "IO Output"
    },
    "CodeStream": {
  ...
  zh: {
    ...
    "LoadSettings": {
      "navTitle": "载重",
      "template": ["型号 ", "当前电压值", "当前重量", "标定数目", "删除", "添加", '序号', '当前电压值', '标定重量'],
      "model": "串口",
  ...
  tw: {
    ...
    "LoadSettings": {
      "navTitle": "载重",
      "template": ["型号 ", "当前电压值", "当前重量", "标定数目", "删除", "添加", '序号', '当前重量', '标定重量'],
      "templatePlaceholder": ["请输入", "请输入", "请输入标定数目", "请输入", "请输入"],
      "fail": ["最多15组"] // -------------
...
/* harmony import */ var vant_lib_index_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! vant/lib/index.css */ "./node_modules/_vant@3.6.2@vant/lib/index.css");
...
(0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)(_App_vue__WEBPACK_IMPORTED_MODULE_1__["default"]).use(_locales_setupI18n__WEBPACK_IMPORTED_MODULE_3__.i18n).use(_router_index__WEBPACK_IMPORTED_MODULE_2__["default"]).mount('#app');
...
var Home = function Home() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_Home_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/Home.vue */ "./src/views/Home.vue"));
};

var SettingsIP = function SettingsIP() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("src_views_SettingsIP_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/SettingsIP.vue */ "./src/views/SettingsIP.vue"));
};

var BSD = function BSD() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("src_views_BSD_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/BSD.vue */ "./src/views/BSD.vue"));
};

var CarInfo = function CarInfo() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_views_CarInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/CarInfo.vue */ "./src/views/CarInfo.vue"));
};

var In3G4G = function In3G4G() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("src_views_3G4G_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/3G4G.vue */ "./src/views/3G4G.vue"));
};

var WifiSettings = function WifiSettings() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_WifiSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/WifiSettings.vue */ "./src/views/WifiSettings.vue"));
};

var PlatformSettings = function PlatformSettings() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_PlatformSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/PlatformSettings.vue */ "./src/views/PlatformSettings.vue"));
};

var ServeInfo = function ServeInfo() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_views_ServeInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/ServeInfo.vue */ "./src/views/ServeInfo.vue"));
};

var CameraSettings = function CameraSettings() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_cell_i-8f7553"), __webpack_require__.e("src_views_CameraSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/CameraSettings.vue */ "./src/views/CameraSettings.vue"));
};

var DiskStatus = function DiskStatus() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_DiskStatus_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/DiskStatus.vue */ "./src/views/DiskStatus.vue"));
};

var Network = function Network() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_Network_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/Network.vue */ "./src/views/Network.vue"));
};

var PlatformStatus = function PlatformStatus() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_PlatformStatus_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/PlatformStatus.vue */ "./src/views/PlatformStatus.vue"));
};

var CameraInfo = function CameraInfo() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("node_modules_core-js_internals_define-built-ins_js-node_modules_core-js_internals_internal-me-51f668"), __webpack_require__.e("src_views_CameraInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/CameraInfo.vue */ "./src/views/CameraInfo.vue"));
};

var ActualTime = function ActualTime() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("src_views_ActualTime_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/ActualTime.vue */ "./src/views/ActualTime.vue"));
};

var Alarm = function Alarm() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_Alarm_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/Alarm.vue */ "./src/views/Alarm.vue"));
};

var AlarmInfo = function AlarmInfo() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("node_modules_core-js_modules_es_array_for-each_js-node_modules_core-js_modules_web_dom-collec-dc93ef"), __webpack_require__.e("src_views_AlarmInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/AlarmInfo.vue */ "./src/views/AlarmInfo.vue"));
};

var Demarcate = function Demarcate() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_Demarcate_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/Demarcate.vue */ "./src/views/Demarcate.vue"));
};

var SystemInfo = function SystemInfo() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_SystemInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/SystemInfo.vue */ "./src/views/SystemInfo.vue"));
};

var ADAS = function ADAS() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("src_views_ADAS_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/ADAS.vue */ "./src/views/ADAS.vue"));
}; // ADAS


var DSM1 = function DSM1() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_DSM1_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/DSM1.vue */ "./src/views/DSM1.vue"));
}; // BSM1


var DSM2 = function DSM2() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_DSM2_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/DSM2.vue */ "./src/views/DSM2.vue"));
}; // BSM1


var AlarmOutput = function AlarmOutput() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_phaseTwo_AlarmOutput_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/AlarmOutput.vue */ "./src/views/phaseTwo/AlarmOutput.vue"));
};

var BurglarAlarm = function BurglarAlarm() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_components_AlarmConfig_vue"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_cell_i-8f7553"), __webpack_require__.e("src_views_phaseTwo_BurglarAlarm_vue-src_components_AlarmConfig_vue-src_components_Alarm_Alarm-b40f5c")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/BurglarAlarm.vue */ "./src/views/phaseTwo/BurglarAlarm.vue"));
};

var SessionSettings = function SessionSettings() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules_core-js_modules_es_array_for-each_js-node_modules_core-js_modules_web_dom-collec-dc93ef"), __webpack_require__.e("src_views_phaseTwo_SessionSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/SessionSettings.vue */ "./src/views/phaseTwo/SessionSettings.vue"));
};

var LoadSettings = function LoadSettings() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_components_ComConfig_vue-node_modules_core-js_modules_es_array_filter_js-node_modules__va-fce7b1"), __webpack_require__.e("src_views_phaseTwo_LoadSettings_vue-src_components_Alarm_AlarmPicker_vue-src_components_ComCo-4f92f9")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/LoadSettings.vue */ "./src/views/phaseTwo/LoadSettings.vue"));
};

var PTZSettings = function PTZSettings() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_phaseTwo_PTZSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/PTZSettings.vue */ "./src/views/phaseTwo/PTZSettings.vue"));
};

var Tyrepressure = function Tyrepressure() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_phaseTwo_Tyrepressure_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/Tyrepressure.vue */ "./src/views/phaseTwo/Tyrepressure.vue"));
};

var TyrepressureDerails = function TyrepressureDerails() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules_core-js_modules_es_array_for-each_js-node_modules_core-js_modules_web_dom-collec-dc93ef"), __webpack_require__.e("src_views_phaseTwo_TyrepressureDerails_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/TyrepressureDerails.vue */ "./src/views/phaseTwo/TyrepressureDerails.vue"));
};

var CodeStream = function CodeStream() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_phaseTwo_CodeStream_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/CodeStream.vue */ "./src/views/phaseTwo/CodeStream.vue"));
};

var CodeStreamDetails = function CodeStreamDetails() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_views_phaseTwo_CodeStreamDetails_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/CodeStreamDetails.vue */ "./src/views/phaseTwo/CodeStreamDetails.vue"));
};

var TemperatureSensingState = function TemperatureSensingState() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_phaseTwo_TemperatureSensingState_vue-src_components_stickyBottom_vue-src_components-2885e2")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/TemperatureSensingState.vue */ "./src/views/phaseTwo/TemperatureSensingState.vue"));
};

var TemperatureSensingStateDetails = function TemperatureSensingStateDetails() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules_core-js_modules_es_array_for-each_js-node_modules_core-js_modules_web_dom-collec-dc93ef"), __webpack_require__.e("src_views_phaseTwo_TemperatureSensingStateDetails_vue-src_components_stickyBottom_vue-src_com-d0ca76")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/TemperatureSensingStateDetails.vue */ "./src/views/phaseTwo/TemperatureSensingStateDetails.vue"));
};

var ComSettings = function ComSettings() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_phaseTwo_ComSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/ComSettings.vue */ "./src/views/phaseTwo/ComSettings.vue"));
};

var ReversingCamera = function ReversingCamera() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_views_phaseTwo_ReversingCamera_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/ReversingCamera.vue */ "./src/views/phaseTwo/ReversingCamera.vue"));
};

var ComInfo = function ComInfo() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_components_AlarmConfig_vue"), __webpack_require__.e("src_views_phaseTwo_ComInfo_vue-src_components_AlarmConfig_vue-src_components_Alarm_AlarmPicke-46ab1f")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/ComInfo.vue */ "./src/views/phaseTwo/ComInfo.vue"));
};
...
var ToilLevel = function ToilLevel() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_components_ComConfig_vue-node_modules_core-js_modules_es_array_filter_js-node_modules__va-fce7b1"), __webpack_require__.e("src_views_phaseTwo_ToilLevel_vue-src_components_Alarm_AlarmPicker_vue-src_components_ComConfi-c456f8")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/ToilLevel.vue */ "./src/views/phaseTwo/ToilLevel.vue"));
};

var AlarmConfigDetails = function AlarmConfigDetails() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_phaseTwo_AlarmConfigDetails_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/AlarmConfigDetails.vue */ "./src/views/phaseTwo/AlarmConfigDetails.vue"));
};

var AlarmConfig = function AlarmConfig() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_phaseTwo_AlarmConfig_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/AlarmConfig.vue */ "./src/views/phaseTwo/AlarmConfig.vue"));
};

var OilParam = function OilParam() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_views_OilParam_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/OilParam.vue */ "./src/views/OilParam.vue"));
}; // 油感


var AlarmIoInfo = function AlarmIoInfo() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("node_modules_core-js_modules_es_array_for-each_js-node_modules_core-js_modules_web_dom-collec-dc93ef"), __webpack_require__.e("src_views_phaseTwo_AlarmIoInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/phaseTwo/AlarmIoInfo.vue */ "./src/views/phaseTwo/AlarmIoInfo.vue"));
}; // 油感


var RotaTestNsor = function RotaTestNsor() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_views_RotaTestNsor_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/RotaTestNsor.vue */ "./src/views/RotaTestNsor.vue"));
}; // 正反转


var OneeireTable = function OneeireTable() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("src_views_OneeireTable_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/OneeireTable.vue */ "./src/views/OneeireTable.vue"));
}; // 温度


var MockView = function MockView() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("node_modules_core-js_internals_define-built-ins_js-node_modules_core-js_internals_internal-me-51f668"), __webpack_require__.e("src_api_http_js"), __webpack_require__.e("src_views_mockTest_mock_vue-node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_mod-911268")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/mockTest/mock.vue */ "./src/views/mockTest/mock.vue"));
}; // 模拟数据


var icCardView = function icCardView() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("src_components_tab_vue"), __webpack_require__.e("node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_picker_index_mjs"), __webpack_require__.e("src_views_IcCard_vue-src_components_stickyBottom_vue-src_components_tab_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/IcCard.vue */ "./src/views/IcCard.vue"));
}; // 模拟数据


var decodeProto = function decodeProto() {
  return Promise.all(/*! import() */[__webpack_require__.e("node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f"), __webpack_require__.e("node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5"), __webpack_require__.e("node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445"), __webpack_require__.e("node_modules_core-js_internals_define-built-ins_js-node_modules_core-js_internals_internal-me-51f668"), __webpack_require__.e("src_api_http_js"), __webpack_require__.e("src_views_decode_decodeProto_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! @/views/decode/decodeProto.vue */ "./src/views/decode/decodeProto.vue"));
}; // 模拟数据
...
var columnOilType = ["TUB", "N08", "PLUG", "ITALON"];
...
/* harmony import */ var _ConfigConst__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./ConfigConst */ "./src/utlis/ConfigConst.js");
...
function arrIndexExchange(array, x, y) {
  array.splice.apply(array, [x - 1, 1].concat((0,D_aEJ_apache_tomcat_9_0_54_webapps_yunweibao_ad_node_modules_babel_runtime_helpers_esm_toConsumableArray_js__WEBPACK_IMPORTED_MODULE_1__["default"])(array.splice(y - 1, 1, array[x - 1]))));
  return array;
} // 十进制转二进制 8位
...
var filterABtn = function filterABtn(num) {
  ...
  function PtzBtn(num) {
    switch (num) {
      case "0":
        str = _ConfigConst__WEBPACK_IMPORTED_MODULE_16__.columnsCheckbits[0];
        break;

      case "1":
        str = _ConfigConst__WEBPACK_IMPORTED_MODULE_16__.columnsCheckbits[1];
        break;

      case "2":
        str = _ConfigConst__WEBPACK_IMPORTED_MODULE_16__.columnsCheckbits[2];
        break;
    }
...
function columnComInfo() {
  var columnIndex = _ConfigConst__WEBPACK_IMPORTED_MODULE_16__.columnCom;
  return columnIndex;
} // 十进制转二进制 8位
...
/* harmony import */ var _App_vue_vue_type_style_index_0_id_cc569128_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./App.vue?vue&type=style&index=0&id=cc569128&lang=css */ "./src/App.vue?vue&type=style&index=0&id=cc569128&lang=css");
...
/***/ "./src/App.vue?vue&type=style&index=0&id=cc569128&lang=css":
/*!*****************************************************************!*\
  !*** ./src/App.vue?vue&type=style&index=0&id=cc569128&lang=css ***!
  \*****************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_mini_css_extract_plugin_dist_loader_js_clonedRuleSet_12_use_0_node_modules_css_loader_dist_cjs_js_clonedRuleSet_12_use_1_node_modules_vue_loader_17_0_0_vue_loader_dist_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_12_use_2_node_modules_vue_loader_17_0_0_vue_loader_dist_index_js_ruleSet_0_use_0_App_vue_vue_type_style_index_0_id_cc569128_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-12.use[0]!../node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!../node_modules/_vue-loader@17.0.0@vue-loader/dist/stylePostLoader.js!../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!../node_modules/_vue-loader@17.0.0@vue-loader/dist/index.js??ruleSet[0].use[0]!./App.vue?vue&type=style&index=0&id=cc569128&lang=css */ "./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-12.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-12.use[1]!./node_modules/_vue-loader@17.0.0@vue-loader/dist/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-12.use[2]!./node_modules/_vue-loader@17.0.0@vue-loader/dist/index.js??ruleSet[0].use[0]!./src/App.vue?vue&type=style&index=0&id=cc569128&lang=css");
...
/******/ 			return "js/" + chunkId + "." + {"node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_modules_babel_runtime_helpers_e-c7f41f":"ec7b4d38","node_modules_babel_runtime_helpers_esm_asyncToGenerator_js-node_modules_babel_runtime_helpers-4fc7f5":"147f02eb","src_components_tab_vue":"c80fc58e","node_modules__thread-loader_3_0_4_thread-loader_dist_cjs_js_node_modules_babel-loader_lib_ind-a156cd":"e131a595","src_views_Home_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3e7eb5f8","node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_field_-967445":"d1b901c4","src_views_SettingsIP_vue-src_components_stickyBottom_vue-src_components_tab_vue":"729add66","src_views_BSD_vue-src_components_tab_vue":"4b20cacb","node_modules__vant_3_6_2_vant_es_picker_index_mjs":"d5810926","src_views_CarInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"74258d70","src_views_3G4G_vue-src_components_stickyBottom_vue-src_components_tab_vue":"248298fe","src_views_WifiSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"506e94ba","src_views_PlatformSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"2f251627","src_views_ServeInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"91123cb2","node_modules__vant_3_6_2_vant_es_cell-group_index_mjs-node_modules__vant_3_6_2_vant_es_cell_i-8f7553":"a4088df5","src_views_CameraSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f60416e6","src_views_DiskStatus_vue-src_components_stickyBottom_vue-src_components_tab_vue":"4e9c3202","src_views_Network_vue-src_components_stickyBottom_vue-src_components_tab_vue":"04f14933","src_views_PlatformStatus_vue-src_components_stickyBottom_vue-src_components_tab_vue":"e945aafa","node_modules_core-js_internals_define-built-ins_js-node_modules_core-js_internals_internal-me-51f668":"b8ca7336","src_views_CameraInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"711d9c99","src_views_ActualTime_vue-src_components_tab_vue":"37f9ab29","src_views_Alarm_vue-src_components_stickyBottom_vue-src_components_tab_vue":"ab3ec9c8","node_modules_core-js_modules_es_array_for-each_js-node_modules_core-js_modules_web_dom-collec-dc93ef":"d3c42729","src_views_AlarmInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f236c42a","src_views_Demarcate_vue-src_components_stickyBottom_vue-src_components_tab_vue":"a3327a15","src_views_SystemInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"c6471487","src_views_ADAS_vue-src_components_stickyBottom_vue-src_components_tab_vue":"4cb69694","src_views_DSM1_vue-src_components_stickyBottom_vue-src_components_tab_vue":"e0506f8f","src_views_DSM2_vue-src_components_stickyBottom_vue-src_components_tab_vue":"9ca9251b","src_views_phaseTwo_AlarmOutput_vue-src_components_stickyBottom_vue-src_components_tab_vue":"9d8a4f6a","src_components_AlarmConfig_vue":"5edcb7f5","src_views_phaseTwo_BurglarAlarm_vue-src_components_AlarmConfig_vue-src_components_Alarm_Alarm-b40f5c":"264e204d","src_views_phaseTwo_SessionSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"895c665f","src_components_ComConfig_vue-node_modules_core-js_modules_es_array_filter_js-node_modules__va-fce7b1":"cd667589","src_views_phaseTwo_LoadSettings_vue-src_components_Alarm_AlarmPicker_vue-src_components_ComCo-4f92f9":"6f768252","src_views_phaseTwo_PTZSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"9f745d95","src_views_phaseTwo_Tyrepressure_vue-src_components_stickyBottom_vue-src_components_tab_vue":"a6f0e757","src_views_phaseTwo_TyrepressureDerails_vue-src_components_stickyBottom_vue-src_components_tab_vue":"4525da88","src_views_phaseTwo_CodeStream_vue-src_components_stickyBottom_vue-src_components_tab_vue":"051a3870","src_views_phaseTwo_CodeStreamDetails_vue-src_components_stickyBottom_vue-src_components_tab_vue":"d7b3f379","src_views_phaseTwo_TemperatureSensingState_vue-src_components_stickyBottom_vue-src_components-2885e2":"edc6acdc","src_views_phaseTwo_TemperatureSensingStateDetails_vue-src_components_stickyBottom_vue-src_com-d0ca76":"133adc65","src_views_phaseTwo_ComSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"6450f3c5","src_views_phaseTwo_ReversingCamera_vue-src_components_stickyBottom_vue-src_components_tab_vue":"41760fff","src_views_phaseTwo_ComInfo_vue-src_components_AlarmConfig_vue-src_components_Alarm_AlarmPicke-46ab1f":"979832d0","src_views_phaseTwo_PTZInfo_vue-src_components_AlarmConfig_vue-src_components_Alarm_AlarmPicke-42ceee":"be7f607d","src_views_phaseTwo_ToilLevel_vue-src_components_Alarm_AlarmPicker_vue-src_components_ComConfi-c456f8":"9486b560","src_views_phaseTwo_AlarmConfigDetails_vue-src_components_stickyBottom_vue-src_components_tab_vue":"dca4985b","src_views_phaseTwo_AlarmConfig_vue-src_components_stickyBottom_vue-src_components_tab_vue":"2db3d7b9","src_views_OilParam_vue-src_components_stickyBottom_vue-src_components_tab_vue":"87eea65c","src_views_phaseTwo_AlarmIoInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"1cb04dfd","src_views_RotaTestNsor_vue-src_components_stickyBottom_vue-src_components_tab_vue":"c745a6ae","src_views_OneeireTable_vue-src_components_stickyBottom_vue-src_components_tab_vue":"b6edb791","src_api_http_js":"42622849","src_views_mockTest_mock_vue-node_modules_babel_runtime_helpers_esm_classCallCheck_js-node_mod-911268":"e77a2542","src_views_IcCard_vue-src_components_stickyBottom_vue-src_components_tab_vue":"0cc4b26a","src_views_decode_decodeProto_vue":"1fc01cff"}[chunkId] + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 			// return url for filenames based on template
/******/ 			return "css/" + chunkId + "." + {"src_views_Home_vue-src_components_stickyBottom_vue-src_components_tab_vue":"14445a8d","src_views_SettingsIP_vue-src_components_stickyBottom_vue-src_components_tab_vue":"dbfc5770","src_views_BSD_vue-src_components_tab_vue":"67bd3814","src_views_CarInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f712fb7f","src_views_3G4G_vue-src_components_stickyBottom_vue-src_components_tab_vue":"d5abc75b","src_views_WifiSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"d1b2cb43","src_views_PlatformSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f712fb7f","src_views_ServeInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f712fb7f","src_views_CameraSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_DiskStatus_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f712fb7f","src_views_Network_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f712fb7f","src_views_PlatformStatus_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f712fb7f","src_views_CameraInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_ActualTime_vue-src_components_tab_vue":"baf43ed5","src_views_Alarm_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_AlarmInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_Demarcate_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f712fb7f","src_views_SystemInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_ADAS_vue-src_components_stickyBottom_vue-src_components_tab_vue":"d1b2cb43","src_views_DSM1_vue-src_components_stickyBottom_vue-src_components_tab_vue":"d1b2cb43","src_views_DSM2_vue-src_components_stickyBottom_vue-src_components_tab_vue":"d1b2cb43","src_views_phaseTwo_AlarmOutput_vue-src_components_stickyBottom_vue-src_components_tab_vue":"0bb9789f","src_views_phaseTwo_BurglarAlarm_vue-src_components_AlarmConfig_vue-src_components_Alarm_Alarm-b40f5c":"2b681b28","src_views_phaseTwo_SessionSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f4964105","src_views_phaseTwo_LoadSettings_vue-src_components_Alarm_AlarmPicker_vue-src_components_ComCo-4f92f9":"a5f6d982","src_views_phaseTwo_PTZSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"5d148937","src_views_phaseTwo_Tyrepressure_vue-src_components_stickyBottom_vue-src_components_tab_vue":"6d33034a","src_views_phaseTwo_TyrepressureDerails_vue-src_components_stickyBottom_vue-src_components_tab_vue":"8becb2e7","src_views_phaseTwo_CodeStream_vue-src_components_stickyBottom_vue-src_components_tab_vue":"dcb8e2e1","src_views_phaseTwo_CodeStreamDetails_vue-src_components_stickyBottom_vue-src_components_tab_vue":"715fb6c6","src_views_phaseTwo_TemperatureSensingState_vue-src_components_stickyBottom_vue-src_components-2885e2":"879630e5","src_views_phaseTwo_TemperatureSensingStateDetails_vue-src_components_stickyBottom_vue-src_com-d0ca76":"3d86081a","src_views_phaseTwo_ComSettings_vue-src_components_stickyBottom_vue-src_components_tab_vue":"df4890fe","src_views_phaseTwo_ReversingCamera_vue-src_components_stickyBottom_vue-src_components_tab_vue":"6c28c0da","src_views_phaseTwo_ComInfo_vue-src_components_AlarmConfig_vue-src_components_Alarm_AlarmPicke-46ab1f":"60526588","src_views_phaseTwo_PTZInfo_vue-src_components_AlarmConfig_vue-src_components_Alarm_AlarmPicke-42ceee":"d4365d0b","src_views_phaseTwo_ToilLevel_vue-src_components_Alarm_AlarmPicker_vue-src_components_ComConfi-c456f8":"c973a7d2","src_views_phaseTwo_AlarmConfigDetails_vue-src_components_stickyBottom_vue-src_components_tab_vue":"cc34b02e","src_views_phaseTwo_AlarmConfig_vue-src_components_stickyBottom_vue-src_components_tab_vue":"b76452c3","src_views_OilParam_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_phaseTwo_AlarmIoInfo_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_RotaTestNsor_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_OneeireTable_vue-src_components_stickyBottom_vue-src_components_tab_vue":"3760b6c9","src_views_IcCard_vue-src_components_stickyBottom_vue-src_components_tab_vue":"f712fb7f","src_views_decode_decodeProto_vue":"5d64e8f9"}[chunkId] + ".css";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=app.67539eb5.js.map