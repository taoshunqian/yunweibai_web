"use strict";
(self["webpackChunkyunweibao_ad"] = self["webpackChunkyunweibao_ad"] || []).push([["src_views_DiskStatus_vue-src_components_stickyBottom_vue-src_components_tab_vue"],{

/***/ "./node_modules/_thread-loader@3.0.4@thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/babel-loader/lib/index.js??clonedRuleSet-41!./node_modules/_vue-loader@17.0.0@vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/DiskStatus.vue?vue&type=script&setup=true&lang=js":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/_thread-loader@3.0.4@thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/babel-loader/lib/index.js??clonedRuleSet-41!./node_modules/_vue-loader@17.0.0@vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/DiskStatus.vue?vue&type=script&setup=true&lang=js ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var vant__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! vant */ "./node_modules/_vant@3.6.2@vant/es/toast/function-call.mjs");
/* harmony import */ var vant__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! vant */ "./node_modules/_vant@3.6.2@vant/es/dialog/function-call.mjs");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(__props) {
    ...
    var i8nStateName = t("diskStatus.stateName");
    var diskStatusLang = t("diskStatus.diskStatusLang");
    var timer;
    var timeState = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)(9); // 标题

    var navTitle = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)(t("diskStatus.navTitle"));
    var disabled = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)(false);
    var loadingActive = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)("");
    var loadingDisabled = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)(false);
    var titlelabel = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)("");
    var loadingText = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)(t("diskStatus.load"));
    var diskInfo = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)([]);
    var itemState = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)(0);
    var diskStatus = (0,vue__WEBPACK_IMPORTED_MODULE_6__.ref)([]);
    var diskState = ["withoulock", "NoDisk", "DiskNoformat", "DiskStateError", "DiskNormal"];

    var settingServe = function settingServe(e) {
      disabled.value = true;
    ...
    function filterDiskState(name) {
      var ti = "";
      var stateName = i8nStateName.split(",");
      var state = diskState.indexOf(name);
    ...
    function FormatClick(title) {
      ...
      var sd = ["SD1", "SD", "TF", "TF1"];

      if (sd.includes(title)) {
        postAN.ANSend("$FORMAT,2");
        itemState.value = 2;
      } else if (title == "SD2" || title == "TF2") {
        ...
        postAN.ANSend("$FORMAT,5");
        itemState.value = 5;
      } else if (title == "EXT") {
        postAN.ANSend("$FORMAT,4");
        itemState.value = 4;
      } // EXT HDD2
      // var num = 0;


      vant__WEBPACK_IMPORTED_MODULE_9__.Toast.loading({
      ...
      timer = setInterval(function () {
        ...
        if (number == 30) {
          clearInterval(timer);
          vant__WEBPACK_IMPORTED_MODULE_9__.Toast.clear();
        }
        ...
        if (timeState.value == 2 || timeState.value == 0) {
          ...
          vant__WEBPACK_IMPORTED_MODULE_10__.Dialog.alert({
            title: t("diskStatus.alert[0]"),
            message: titlelabel.value + " " + t("diskStatus.alertMsg[" + timeState.value + "]"),
    ...
    var callJSResult = function callJSResult(str) {
      ...
      diskInfo.value = cmd; // console.log(cmd);
    }; // 向安卓发送指令


    var androidStatus_fn = function androidStatus_fn() {
      var param = (0,_utlis_QueryStr__WEBPACK_IMPORTED_MODULE_8__.getQueryString)("param").split("@"); // 解析出指令
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_6__.onDeactivated)(function () {
      clearInterval(timer);
      vant__WEBPACK_IMPORTED_MODULE_9__.Toast.clear();
    });
    return function (_ctx, _cache) {
      return (0,vue__WEBPACK_IMPORTED_MODULE_6__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_6__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_6__.unref)(TabHeaders), {
        ...
        leftArrow: false
      }, null, 8, ["navTitle"]), ((0,vue__WEBPACK_IMPORTED_MODULE_6__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_6__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_6__.renderList)(diskInfo.value, function (item, index) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_6__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_6__.unref)(vant__WEBPACK_IMPORTED_MODULE_11__.CellGroup), {
          inset: "",
          style: {
            "margin": "10px"
          },
          ...
          "default": (0,vue__WEBPACK_IMPORTED_MODULE_6__.withCtx)(function () {
            return [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_6__.unref)(vant__WEBPACK_IMPORTED_MODULE_12__.Cell), null, {
              title: (0,vue__WEBPACK_IMPORTED_MODULE_6__.withCtx)(function () {
                return [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("label", _hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(_ctx.$t("diskStatus.title[0]")) + ": " + (0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(item[0]), 1), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("p", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(_ctx.$t("diskStatus.title[1]")) + ": ", 1), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("span", {
                  style: (0,vue__WEBPACK_IMPORTED_MODULE_6__.normalizeStyle)({
                    color: item[1] == 'DiskNormal' ? '#5fb878' : 'red'
                  })
                }, (0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(filterDiskState(item[1])), 5)]), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("p", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(_ctx.$t("diskStatus.title[5]")) + ": ", 1), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("span", null, (0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(diskStatusFn(diskStatus.value, item[0])), 1)])];
              }),
              "right-icon": (0,vue__WEBPACK_IMPORTED_MODULE_6__.withCtx)(function () {
                return [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("p", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(_ctx.$t("diskStatus.title[2]")) + ": ", 1), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("span", _hoisted_6, (0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(item[2]), 1)]), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("p", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(_ctx.$t("diskStatus.title[3]")) + ": ", 1), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createElementVNode)("span", _hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(item[3]), 1)]), (0,vue__WEBPACK_IMPORTED_MODULE_6__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_6__.unref)(vant__WEBPACK_IMPORTED_MODULE_13__.Button), {
                  type: "primary",
                  size: "small",
                  style: {
                    "float": "right"
                  ...
                  onClick: function onClick($event) {
                    return settingServe(item[0]);
                  },
                  "loading-text": loadingText.value,
                  disabled: disabled.value,
                  loading: loadingActive.value == item[0] ? true : false
                }, {
                  "default": (0,vue__WEBPACK_IMPORTED_MODULE_6__.withCtx)(function () {
                    return [(0,vue__WEBPACK_IMPORTED_MODULE_6__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_6__.toDisplayString)(_ctx.$t("diskStatus.title[4]")), 1)];
                  }),
                  _: 2
                }, 1032, ["onClick", "loading-text", "disabled", "loading"])])];
              }),
              _: 2
            }, 1024)];
          }),
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DiskStatus_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DiskStatus.vue?vue&type=script&setup=true&lang=js */ "./src/views/DiskStatus.vue?vue&type=script&setup=true&lang=js");



const __exports__ = _DiskStatus_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"];

/* harmony default export */ __webpack_exports__["default"] = (__exports__);

/***/ }),

/***/ "./src/views/DiskStatus.vue?vue&type=script&setup=true&lang=js":
/*!*********************************************************************!*\
  !*** ./src/views/DiskStatus.vue?vue&type=script&setup=true&lang=js ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": function() { return /* reexport safe */ _node_modules_thread_loader_3_0_4_thread_loader_dist_cjs_js_node_modules_babel_loader_lib_index_js_clonedRuleSet_40_use_1_node_modules_babel_loader_lib_index_js_clonedRuleSet_41_node_modules_vue_loader_17_0_0_vue_loader_dist_index_js_ruleSet_0_use_0_DiskStatus_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]; }
/* harmony export */ });
/* harmony import */ var _node_modules_thread_loader_3_0_4_thread_loader_dist_cjs_js_node_modules_babel_loader_lib_index_js_clonedRuleSet_40_use_1_node_modules_babel_loader_lib_index_js_clonedRuleSet_41_node_modules_vue_loader_17_0_0_vue_loader_dist_index_js_ruleSet_0_use_0_DiskStatus_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../node_modules/_thread-loader@3.0.4@thread-loader/dist/cjs.js!../../node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!../../node_modules/babel-loader/lib/index.js??clonedRuleSet-41!../../node_modules/_vue-loader@17.0.0@vue-loader/dist/index.js??ruleSet[0].use[0]!./DiskStatus.vue?vue&type=script&setup=true&lang=js */ "./node_modules/_thread-loader@3.0.4@thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-40.use[1]!./node_modules/babel-loader/lib/index.js??clonedRuleSet-41!./node_modules/_vue-loader@17.0.0@vue-loader/dist/index.js??ruleSet[0].use[0]!./src/views/DiskStatus.vue?vue&type=script&setup=true&lang=js");
...
//# sourceMappingURL=src_views_DiskStatus_vue-src_components_stickyBottom_vue-src_components_tab_vue.4e9c3202.js.map