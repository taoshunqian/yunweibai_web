...
const { t } = useI18n();
const i8nConnectState = t("settingsIP.connectState");
...
const callJSResult = (str) => {
  ...
  if (str.indexOf("WIFISEARCH") !== -1) {
    ...
    for (var i = 0; i < cmdArr2.length; i++) {
      ...
      items.push({
        id: item[0] + "",
        name: t("settingsIP.itemList[0]") + getWifiASC(item[0]),
