    ...
    en: {
        ...
        "LoadSettings": {
            ...
            "template": [
                ...
                "Delete", "Add", 'ID', 'Current voltage', 'Calibrated weight'
            ],
            "model": "COM",
            "templatePlaceholder": [
        ...
        "Oil3011": {
            "template": [
                "Sensor serial number ", "Serial port number", "type", "Current oil level",
                "Substring slogan", "Total capacity", "Current oil volume","tank"
            ],
            "navTitle": "oil",
        },
        "OilBefore3011": {
            "template": [
                "Serial port number ", "tank", "Not", "oil level"
            ],
            "navTitle": "tank ",
        },
        "Tyrepressure": {
